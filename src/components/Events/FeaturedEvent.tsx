...
const FeaturedEvent: React.FC<FeaturedEventProps> = ({ event, ticketUrl }) => {
  ...
  return (
    // Special Event - White background with proper contrast
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-2xl shadow-xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 p-4 sm:p-6 lg:p-10">
        ...
        <div className="flex items-center justify-center order-2 lg:order-1">
          {event.image ? (
            ...
            <div className="w-full max-w-sm lg:max-w-md aspect-[2/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg border-2 border-gray-300 flex items-center justify-center relative">
              <div className="text-center p-6 sm:p-8">
                {/* Visual indicator - Icon */}
                <div className="text-5xl sm:text-6xl mb-4">🎬</div>
                <p className="text-rich-black font-alt-gothic text-lg sm:text-xl mb-2">
                  Documentary Poster
                </p>
                <p className="text-gray-600 text-sm">Image Coming Soon</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col justify-center order-1 lg:order-2 space-y-4 sm:space-y-6">
          ...
          <div className="inline-block px-3 sm:px-4 py-2 bg-fire-red text-white border-2 border-red-400 rounded-lg text-xs sm:text-sm font-bold w-fit shadow-lg">
            ⚡ SPECIAL EVENT
          </div>
          ...
          <p className="text-gray-700 leading-relaxed text-base sm:text-lg lg:text-xl">{event.description}</p>
          ...
          {ticketUrl && (
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-purple-600 hover:bg-purple-700 text-white text-sm sm:text-base font-bold rounded-xl hover:scale-105 transition-all shadow-xl group mt-4 sm:mt-6"
            >
